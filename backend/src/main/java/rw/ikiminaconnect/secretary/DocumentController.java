...
public class DocumentController {
    ...
    public DocumentController(SecretaryOpsService secretaryOpsService) {
        this.secretaryOpsService = secretaryOpsService;
    }

    @GetMapping
    public List<DocumentDto> list(@AuthenticationPrincipal CurrentUser currentUser) {
        return secretaryOpsService.listDocuments(currentUser.organizationId(), isStaff(currentUser));
    }
    ...
    public DocumentDto add(
            @AuthenticationPrincipal CurrentUser currentUser, @Valid @RequestBody CreateDocumentRequest request) {
        return secretaryOpsService.addDocument(
