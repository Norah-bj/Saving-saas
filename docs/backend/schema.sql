...
-- loans                       — core lending entity (phase 5)
-- loan_timeline_events        — child table of loans, not a JSON column (phase 5)
-- guarantees                  — links a loan to a guarantor user (phase 6)
