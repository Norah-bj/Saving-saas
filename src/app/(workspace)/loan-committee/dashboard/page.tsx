...
export default function LoanCommitteeDashboardPage() {
  ...
  return (
    <div className="flex flex-col gap-6">
      <div>
        <h1 className="text-xl font-semibold tracking-tight">Loan Committee Dashboard</h1>
      ...
      <div className="grid gap-4 lg:grid-cols-3">
        ...
        <Card className="lg:col-span-2">
          <CardHeader className="flex flex-row items-center justify-between">
            ...
            <Button variant="ghost" size="sm" render={<Link href="/loan-committee/decisions" />}>
          ...
          <CardContent className="flex flex-col gap-2">
            {recentDecisions.length === 0 ? (
              ...
              recentDecisions.map((loan) => (
                <Link
                  key={loan.id}
                  href={`/loan-committee/pending/${loan.id}`}
