...
export default function LoanReviewDetailPage({ params }: { params: Promise<{ id: string }> }) {
  const { id } = use(params);
  ...
  return (
    <div className="mx-auto flex max-w-4xl flex-col gap-6">
      <div>
        <Button variant="ghost" size="sm" render={<Link href="/loan-committee/pending" />} className="mb-2 -ml-2">
      ...
      <ConfirmDialog
        ...
        onConfirm={() => {
          ...
          router.push("/loan-committee/pending");
        }}
      />
      <ConfirmDialog
        open={confirmReject}
