      ...
      <div className="grid gap-4 lg:grid-cols-3">
        ...
        <Card>
          ...
          <CardContent className="flex flex-col gap-3">
            ...
            <Button variant="outline" size="sm" render={<Link href="/member/meetings" />}>
              View all meetings
            </Button>
          </CardContent>
        </Card>
      ...
      <div className="grid gap-4 lg:grid-cols-3">
        <Card className="lg:col-span-2">
          <CardHeader className="flex flex-row items-center justify-between">
            ...
            <Button variant="ghost" size="sm" render={<Link href="/member/savings/statement" />}>
        ...
        <Card>
          ...
          <CardContent className="flex flex-col gap-3">
            ...
            <Button variant="outline" size="sm" render={<Link href="/member/announcements" />}>
        ...
        <Card>
          ...
          <CardContent>
            <DataTable
              ...
              rows={myLoans}
              rowKey={(r) => r.id}
              onRowClick={(r) => router.push(`/member/loans/${r.id}`)}
            />
          </CardContent>
        </Card>
      )}
